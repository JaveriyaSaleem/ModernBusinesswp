<?php
// add title support
add_theme_support('title-tag');     //it will add title dynamatically no hard cord on index

// add css and js
add_action('wp_enqueue_scripts', 'mb_scripts'); //all style js will be shown cuz of them
function mb_scripts() {	

    // CSS
wp_enqueue_style('mb-bootstrap-icons', 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css', array(), '1.0');

// array means if any css file has to load before this one see below we added top file mb means modern business
...
// we made 2 menu added all menus in wordpress
// register menus
...
// this is in the code of modern businesss file for footer and header menu 
// mb custom menu
